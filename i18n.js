...
window.I18N = {
  de: {
    ...
    lblGear: "Tempo-Grenze je Stufe",
    gear1: "Stufe 1",
    gear2: "Stufe 2 (Komfort)",
    gear3: "Stufe 3 (Tempomat)",
    gear4: "Modus-Grenze 1",
    gear5: "Modus-Grenze 0",
    btnWrite: "Schreiben",
    fineHint: "Für gezielte Versuche. Der Motorwert ist eine interne Zahl, kein km/h-Wert. Die Tempo-Grenzen je Stufe sind km/h-nah. Immer in kleinen Schritten testen.",
  ...
  en: {
    ...
    lblGear: "Speed limit per step",
    gear1: "Step 1",
    gear2: "Step 2 (comfort)",
    gear3: "Step 3 (cruise)",
    gear4: "Mode limit 1",
    gear5: "Mode limit 0",
    btnWrite: "Write",
    fineHint: "For targeted experiments. The motor value is an internal number, not km/h. The per-step speed limits are close to km/h. Always test in small steps.",
